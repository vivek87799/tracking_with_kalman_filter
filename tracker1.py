...
import numpy as np
from traking.kalman_filter1 import KalmanFilter
...
class Track(object):
    ...
    def __init__(self, prediction, trackIdCount, cls_pred=None):
...
class Tracker(object):
    ...
    def Update(self, detections, cls_preds=None):
        ...
        for i in range(len(self.tracks)):
            for j in range(len(detections)):
                try:
                    print("[INFO]prev detection and curr detection", self.tracks[i].prediction, detections[j])
