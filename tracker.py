    ...
    def Update(self, detections):
        ...
        for i in range(len(assignment)):
            ...
            if assignment[i] != -1:
                ...
                diff_x = detections[assignment[i]][0][0] - self.tracks[i].KF.b[0][0]
                diff_y = detections[assignment[i]][1][0] - self.tracks[i].KF.b[1][0]
                self.tracks[i].KF.velocity(diff_x, diff_y)
